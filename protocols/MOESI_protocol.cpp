...
static const char *MOESI_block_states[] = {
	"X","I","S","E","O","M", "IM", "IS"
};
    ...
    : Protocol (my_table, my_entry)
{
	...
	this->name = "MOESI_protocol";
	this->block_states = MOESI_block_states;
}
...
const char *MOESI_protocol::get_state_str()
{
...
{
	const MOESI_cache_state_t states[] = {MOESI_CACHE_E, MOESI_CACHE_S};
	const char *msgs[] = {
